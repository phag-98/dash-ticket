        ...
        <Card title="Faturamento por Campeonato e Ano" subtitle="● 2024  ● 2025  ● 2026">
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={fatData} layout="vertical" margin={{ top: 8, right: 60, bottom: 4, left: 110 }}>
              ...
              <Bar dataKey="2024" name="2024" fill={Y2024} radius={[0, 3, 3, 0]} barSize={7}>
                <LabelList dataKey="2024" position="right" formatter={fmtM} style={{ fontSize: 7, fill: C.t3 }} />
              </Bar>
              <Bar dataKey="2025" name="2025" fill={Y2025} radius={[0, 3, 3, 0]} barSize={7}>
                <LabelList dataKey="2025" position="right" formatter={fmtM} style={{ fontSize: 7, fill: Y2025 }} />
              </Bar>
              <Bar dataKey="2026" name="2026" fill={Y2026} radius={[0, 3, 3, 0]} barSize={7}>
                <LabelList dataKey="2026" position="right" formatter={fmtM} style={{ fontSize: 7, fill: Y2026 }} />
              </Bar>
            </BarChart>
          </ResponsiveContainer>
        </Card>
        ...
        <Card title="Faturamento Médio por Campeonato e Ano">
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={fatMedData} margin={{ top: 8, right: 16, bottom: 12, left: 8 }}>
              ...
              <RTooltip content={<DarkTooltip />} />
              <Bar dataKey="2024" name="2024" fill={Y2024} barSize={10} radius={[3, 3, 0, 0]}>
                <LabelList dataKey="2024" position="top" formatter={fmtM} style={{ fontSize: 7, fill: C.t3 }} />
              </Bar>
              <Bar dataKey="2025" name="2025" fill={Y2025} barSize={10} radius={[3, 3, 0, 0]}>
                <LabelList dataKey="2025" position="top" formatter={fmtM} style={{ fontSize: 7, fill: Y2025 }} />
              </Bar>
              <Bar dataKey="2026" name="2026" fill={Y2026} barSize={10} radius={[3, 3, 0, 0]}>
                <LabelList dataKey="2026" position="top" formatter={fmtM} style={{ fontSize: 7, fill: Y2026 }} />
              </Bar>
            </BarChart>
          </ResponsiveContainer>
        </Card>
        ...
        <Card title="Faturamento por ANO">
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={[{ ano: '2024', valor: fat2024 }, { ano: '2025', valor: fat2025 }, { ano: '2026', valor: fat2026 }]} margin={{ top: 8, right: 16, bottom: 8, left: 8 }}>
              ...
              <YAxis tick={{ fill: C.t3, fontSize: 8 }} axisLine={false} tickLine={false} tickFormatter={fmtM} />
              <RTooltip content={<DarkTooltip />} />
              <Bar dataKey="valor" name="Faturamento" radius={[4, 4, 0, 0]} barSize={50}>
        ...
        <Card title="Ticket Médio por Campeonato e Ano">
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={tktData} margin={{ top: 8, right: 16, bottom: 12, left: 8 }}>
              ...
              <Bar dataKey="2025" name="2025" fill={Y2025} barSize={10} radius={[3, 3, 0, 0]}>
                <LabelList dataKey="2025" position="top" style={{ fontSize: 7, fill: Y2025 }} />
              </Bar>
              <Bar dataKey="2026" name="2026" fill={Y2026} barSize={10} radius={[3, 3, 0, 0]}>
                <LabelList dataKey="2026" position="top" style={{ fontSize: 7, fill: Y2026 }} />
              </Bar>
            </BarChart>
          </ResponsiveContainer>
        </Card>
        ...
        <Card title="Média de Público por Campeonato e Ano">
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={pubData} margin={{ top: 8, right: 16, bottom: 12, left: 8 }}>
              ...
              <Bar dataKey="2025" name="2025" fill={Y2025} barSize={10} radius={[3, 3, 0, 0]}>
                <LabelList dataKey="2025" position="top" formatter={fmtK} style={{ fontSize: 7, fill: Y2025 }} />
              </Bar>
              <Bar dataKey="2026" name="2026" fill={Y2026} barSize={10} radius={[3, 3, 0, 0]}>
                <LabelList dataKey="2026" position="top" formatter={fmtK} style={{ fontSize: 7, fill: Y2026 }} />
              </Bar>
            </BarChart>
          </ResponsiveContainer>
        </Card>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 11 }}>
            <thead>
              <tr style={{ background: C.bgAlt }}>
                ...
                <th style={{ padding: '6px 8px', textAlign: 'center', fontSize: 9, fontWeight: 700, color: Y2024 }}>2024</th>
                <th style={{ padding: '6px 8px', textAlign: 'center', fontSize: 9, fontWeight: 700, color: Y2025 }}>2025</th>
                <th style={{ padding: '6px 8px', textAlign: 'center', fontSize: 9, fontWeight: 700, color: Y2026 }}>2026</th>
            ...
            <tbody>
              {jogosTable.map((r, i) => (
                <tr key={r.campeonato} style={{ borderBottom: `1px solid ${C.border}`, background: i % 2 === 0 ? 'transparent' : C.bgAlt + '44' }}>
                  ...
                  <td style={{ padding: '6px 8px', textAlign: 'center', color: Y2024, fontWeight: 600 }}>{r['2024'] || '—'}</td>
                  <td style={{ padding: '6px 8px', textAlign: 'center', color: Y2025, fontWeight: 600 }}>{r['2025'] || '—'}</td>
                  <td style={{ padding: '6px 8px', textAlign: 'center', color: Y2026, fontWeight: 600 }}>{r['2026'] || '—'}</td>
              ...
              <tr style={{ borderTop: `2px solid ${C.border}`, background: C.bgAlt }}>
                ...
                <td style={{ padding: '6px 8px', textAlign: 'center', color: Y2024, fontWeight: 700 }}>{totalJogos['2024']}</td>
                <td style={{ padding: '6px 8px', textAlign: 'center', color: Y2025, fontWeight: 700 }}>{totalJogos['2025']}</td>
                <td style={{ padding: '6px 8px', textAlign: 'center', color: Y2026, fontWeight: 700 }}>{totalJogos['2026']}</td>
